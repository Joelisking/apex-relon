...
export function CustomerCustomFields({ clientId }: Props) {
              ...
              <div key={def.id} className="space-y-1.5">
                ...
                {def.fieldType === 'SELECT' && (
                  <Select
                    ...
                    onValueChange={(v) => setField(def.id, v === '__none__' ? '' : v)}>
                  ...
                  <div className="flex items-center gap-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        setField(def.id, checked ? 'true' : 'false')
                      }
                    />
                    <label
