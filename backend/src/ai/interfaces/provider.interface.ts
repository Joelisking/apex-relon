...
export interface AIProvider {
  analyzeLeadRisk(lead: Record<string, unknown>): Promise<LeadRiskAnalysis>;
  generateClientHealth(client: Record<string, unknown>): Promise<ClientHealthReport>;
  generateExecutiveSummary(metrics: Record<string, unknown>): Promise<ExecutiveSummary>;
  generateUpsellStrategy(client: Record<string, unknown>): Promise<UpsellStrategy>;
